      ...
      <h3>
        ...
        >
          ...
          <span aria-hidden="true" className="relative h-3 w-3 shrink-0">
            ...
            <span
              className="absolute left-1/2 top-0 h-full w-px -translate-x-1/2 bg-current transition-transform duration-(--dur-normal)"
        ...
        {open && (
          <motion.div
            ...
            animate={{
              ...
              opacity: 1,
              transition: {
                height: { duration: reduced ? 0 : DUR.normal, ease: EASE },
                opacity: { duration: reduced ? 0 : DUR.normal, ease: EASE, delay: reduced ? 0 : 0.06 },
              },
            }}
            exit={{
              height: 0,
